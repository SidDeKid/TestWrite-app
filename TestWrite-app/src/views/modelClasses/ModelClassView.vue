    ...
    makeClass() {
      ...
      */
      public async getData(): Promise<string | true> {
        ...
        await axios
          .get(APIHelper.${listName} + this.id, {
            headers: {
              "Content-Type": "utf-8"
            }
          })
...
<template>
  <div class="modelClass page">
    ...
    <div class="section" v-if="result !== null">
      <h2>Resultaat</h2>
      <div id="result" v-html="result.innerHTML"></div>
    </div>
  </div>
</template>
